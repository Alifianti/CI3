...
<div class="bgded overlay" style="background-image:url(<?php echo base_url('assets/images/demo/backgrounds/01.jpg')?>);"> 
  ...
  <div class="wrapper">
    ...
    <?php echo form_open('data/do_update')?>
  <form>
    ...
    <div class="form-group">
      ...
      <input type="text" class="btn btn-default" placeholder="Tempat" name="tempat" value="<?php echo set_value('tempat', $tempat)?>">
    </div>
    <br>
    
    <div class="form-group">
      <label for="judul">Harga</label>
      <input type="text" class="btn btn-default" placeholder="Harga Masuk" name="harga_masuk" value="<?php echo set_value('harga_masuk', $harga_masuk)?>">
    </div>
    <br>
