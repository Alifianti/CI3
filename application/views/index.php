...
<title>Alfianti Widyastuti</title>
    ...
    <div class="container">
      <div class="row">
        <div class="intro-text">
          ...
          <h1>Hello, I'm <?php	echo $name['firstname']?> <?php	echo $name['lastname']?><span class="name"></span></h1>
  ...
  <nav class="navbar navbar-custom">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand page-scroll" href="#page-top">Alfianti Widyastuti </a> </div>
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        <ul class="nav navbar-nav">
          ...
          <li> <a class="page-scroll" href="#portfolio">Galerry</a> </li>
...
<div id="about">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12 text-center"><img src="assets/img/about.jpg" width="4160" height="3120"></div>
      <div class="col-md-8 col-md-offset-2">
        <div class="about-text">
          <p>Nama saya Alfianti Widyastuti biasa di panggil afi, Saya lahir di Malang 29 Juli 1998. Hobi saya Makan, Jalan Jalan. Cita Cita saya Kurus, Keliling Indonesia, Luar Negeri (InsyaAllah). Saya Lulusan SMKN 5 jurusan TKJ dan sekarang saya Kuliah di Politeknik Negeri Malang jurusan Teknologi Informasi, Prodi Managemen Informatika.</p>
          <p>Saya suka kemewahan, yaitu ngopi di angkringan/di coban, sambil ketawa sama teman teman. sungguh itu sebuah kenikmatan. tak lupa saya abadikan dengan kamera di Hp saya, lalu saya post di sosial media yang saya punya. maklum, human jaman now. difoto dulu seperti sebuah adat bagi kami. jangan di contoh ya hehehe.</p>
          <p>sekian sedikit biografi saya, semoga tidak menyesal setelah membaca:)</p>
...
<div id="skills" class="text-center">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 skill"> <span class="chart" data-percent="98"> <span class="percent">98</span> </span>
        <h4>Makan</h4>
      </div>
      <div class="col-md-4 col-sm-6 skill"> <span class="chart" data-percent="98"> <span class="percent">98</span> </span>
        <h4>Jalan-Jalan</h4>
      ...
      <ul class="cat">
        <li>
          <ol class="type">
            ...
            <li><a href="#" data-filter=".web">Nature</a></li>
            <li><a href="#" data-filter=".app">Sunset</a></li>
            <li><a href="#" data-filter=".branding">Enjoy</a></li>
          </ol>
        </li>
      </ul>
      ...
      <div class="portfolio-items">
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/01-large.jpg" title="Project description" rel="prettyPhoto">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/02-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/03-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
                <small>Web Design</small> </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/04-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
                <small>Web Design</small> </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/05-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
                <small>App Development</small> </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 branding">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/06-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 branding app">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/07-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
                <small>App Development, Branding</small> </div>
              <img src="assets/img/portfolio/07-small.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="assets/img/portfolio/08-large.jpg" title="Project description" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Project Title</h4>
                <small>Web Design</small> </div>
              <img src="assets/img/portfolio/08-small.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
      </div>
    </div>
